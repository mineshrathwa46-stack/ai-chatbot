  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
        <div className="w-full max-w-xl rounded-3xl border border-white/10 bg-slate-950/90 p-10 text-center shadow-2xl">
          <h1 className="text-4xl font-bold">VisionAI</h1>
          <p className="mt-4 text-slate-400">
            Sign in with Google to access the AI vision assistant.
          </p>

          <button
            onClick={handleGoogleSignIn}
            className="mt-8 inline-flex items-center justify-center rounded-full bg-indigo-600 px-6 py-3 text-sm font-semibold transition hover:bg-indigo-500"
          >
            Sign in with Google
          </button>
          ...
          <p className="mt-6 text-sm text-slate-500">
            Use your Google account to access VisionAI. The app will verify
            your credential on the backend.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="absolute left-0 right-0 top-0 z-50 flex items-center justify-between bg-gradient-to-b from-black/90 to-transparent px-6 py-5">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-xs text-slate-300 backdrop-blur">
            {user?.picture && (
              <img
            ...
            <button
              ...
              className="rounded-full bg-red-600 px-3 py-2 text-xs text-white transition hover:bg-red-500"
            >
              Logout
            </button>
          </div>
